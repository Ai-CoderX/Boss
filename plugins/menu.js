...
async (conn, mek, m, { from, sender, reply, userConfig }) => {
    try {
        ...
        const BOT_NAME = userConfig?.BOT_NAME || config.BOT_NAME || "SIGMA-MD";
        const OWNER_NAME = userConfig?.OWNER_NAME || config.OWNER_NAME || "SIGMA";
        ...
        await conn.sendMessage(from, { 
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: { 
                    newsletterJid: '120363430938004868@newsletter', 
